    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SaleInvoices", x => new { x.Year, x.InvoiceCode });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SaleInvoiceDetails", x => new { x.Year, x.InvoiceCode, x.ProductCode, x.LineNumber });
                    table.ForeignKey(
                        name: "FK_SaleInvoiceDetails_Products_ProductCode",
                        column: x => x.ProductCode,
                        principalTable: "Products",
                        principalColumn: "ProductCode",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SaleInvoiceDetails_SaleInvoices_Year_InvoiceCode",
                        columns: x => new { x.Year, x.InvoiceCode },
                        principalTable: "SaleInvoices",
                        principalColumns: new[] { "Year", "InvoiceCode" },
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SaleInvoiceDetails_ProductCode",
